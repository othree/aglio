...
(function() {
  var AttributesKit, ROOT, React, ReactDomServer, benchmark, cache, compileTemplate, crypto, decorate, errMsg, expandDataStructures, fs, getCached, getCss, getTemplate, highlight, hljs, less, markdownIt, modifyUriTemplate, moment, path, pug, queryString, renderExample, renderSchema, sha1, slug;
  ...
  decorate = function(api, md, slugCache, verbose) {
    var action, category, dataStructure, dataStructures, element, err, example, html, i, item, j, k, knownParams, l, len, len1, len2, len3, meta, name, newParams, param, ref, ref1, ref2, ref3, resource, resourceGroup, results, reversed, schema, slugify, tempDS;
                  ...
                  results3.push((function() {
                    ...
                    for (q = 0, len8 = ref7.length; q < len8; q++) {
                      ...
                      results4.push((function() {
                        var len10, len11, len12, len9, r, ref10, ref11, ref8, ref9, results5, s, t, u;
                        ref8 = example[name] || [];
                        results5 = [];
